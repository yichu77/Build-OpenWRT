...
#git clone https://github.com/sirpdboy/luci-theme-opentopd.git feeds/luci/themes/luci-theme-opentopd #主题
#git clone https://github.com/sirpdboy/luci-app-advanced.git feeds/luci/applications/luci-app-advanced #高级设置
