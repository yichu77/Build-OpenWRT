...
git clone https://github.com/sirpdboy/luci-theme-opentopd.git package/emortal/luci-theme-opentopd #主题
git clone https://github.com/sirpdboy/luci-app-advanced.git package/emortal/luci-app-advanced #高级设置
git clone https://github.com/ntlf9t/luci-app-easymesh.git package/emortal/luci-app-easymesh #简单mesh
